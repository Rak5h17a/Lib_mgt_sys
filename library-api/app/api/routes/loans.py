...
async def borrow(payload: BorrowRequest, service: LoanService =  Depends(get_loan_service)):
    try:
...
async def return_loan(loan_id: str, service: LoanService = Depends(get_loan_service)):
    try:
